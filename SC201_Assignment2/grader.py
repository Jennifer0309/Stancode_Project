...
-----------------------------
Milestone 4 answer:
Training error will decrease and Validation error will increase
"""
...
grader.add_basic_part('3b-0', test3b0, max_points=10, max_seconds=1,
...
grader.add_basic_part('3c-0', test3c0, max_points=10, max_seconds=1,
...
grader.add_basic_part('4a-0', test4a0, max_points=5, max_seconds=1,
...
grader.add_basic_part('4a-1', test4a1, max_points=5, max_seconds=2,
...
grader.add_basic_part('4a-2', test4a2, max_points=30, max_seconds=45,
...
# TODO: Official: train error = 0.0, validation error = 0.27687113111986494
# TODO: weights increase,train error decrease to 0 and validation error increase
# EX: movie -> movi ovie , weight increase
...
grader.add_basic_part('5a-0', test5a0, max_points=5, max_seconds=2,
...
grader.add_basic_part('5a-1', test5a1, max_points=5, max_seconds=2,
