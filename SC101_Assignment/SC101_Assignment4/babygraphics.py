...
#             rank = name_data.get(name, {}).get(str(year), None)
#             y = GRAPH_MARGIN_SIZE + rank * rank_h if rank else CANVAS_HEIGHT - GRAPH_MARGIN_SIZE
#             canvas.create_text(x + TEXT_DX, y, text=f'{name} {rank if rank else "*"}', anchor=tkinter.SW, fill=color)
#
